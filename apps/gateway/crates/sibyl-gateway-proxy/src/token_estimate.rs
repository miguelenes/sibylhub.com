...
pub enum PromptInput {
    ...
    Chat(Box<sibyl_gateway_hub::chat::ChatFormat>),
...
fn count_chat_prompt(bpe: &CoreBPE, req: &sibyl_gateway_hub::chat::ChatFormat) -> u32 {
    let mut n: u32 = 0;
...
fn role_label(role: &sibyl_gateway_hub::chat::Role) -> &'static str {
    match role {
        sibyl_gateway_hub::chat::Role::System => "system",
        sibyl_gateway_hub::chat::Role::User => "user",
        sibyl_gateway_hub::chat::Role::Assistant => "assistant",
        sibyl_gateway_hub::chat::Role::Tool => "tool",
    }
}
