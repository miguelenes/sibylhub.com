...
/// toward `sibyl_gateway_config_reloads_total` (boot and SIGHUP reloads both do).
///
...
fn resource_counts(snap: &GatewaySnapshot) -> std::collections::BTreeMap<String, usize> {
