...
// E2E for AISIX-Cloud#1002: the sibyl_gateway_llm_tokens_by_client_total series gained
...
// sibyl_gateway_llm_total_tokens_total total (#679) and the CP display total (#906).
//
// The native /v1/messages path was the concrete gap: it committed the
// cache-inclusive total to TPM (#995) and reported it on sibyl_gateway_llm_total_tokens
...
describe("sibyl_gateway_llm_tokens_by_client_total token_type=total is cache-inclusive (AISIX-Cloud#1002)", () => {
