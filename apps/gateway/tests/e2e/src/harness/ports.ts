...
// Port allocation for everything the harness binds (spawned `sibyl-gateway`
...
// mock server) before `sibyl-gateway` — whose bind happens a spawn later —
// got to it. Observed as startup flakes where `sibyl-gateway` exits 1 with
